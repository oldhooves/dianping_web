					...
					<table class="tab1" width="100%">
						<tbody>
							<tr>
								...
								<td width="30%">
									<input name="title" id="title" class="allInput" style="width:100%;" type="text"/>
								</td>
								<td align="right" width="15%">副标题<font color="red">*</font>：</td>
								<td width="30%">
									<input name="subtitle" id="subtitle" class="allInput" style="width:100%;" type="text"/>
								</td>
							</tr>
							<tr>
							...
							<tr>
								...
								<td width="30%">
									<input name="price"  id="price" class="allInput" style="width:100%;" type="text"/>
								</td>
								<td align="right" width="10%">距离(单位：米)<font color="red">*</font>：</td>
								<td width="30%">
									<input name="distance" id="distance" class="allInput" style="width:100%;" type="text"/>
								</td>
							</tr>
							<tr>
